...
export const MarketplaceSearchFiltersSchema = z.object({
  commodities: z.array(CuidQueryParam('id')).optional(),
  suppliers: z.array(CuidQueryParam('id')).optional(),
  location: z.object({
    center: z.object({
      lat: z.number(),
      lng: z.number(),
  ...
  data: z.object({
    ...
    attributes: z.object({
      ...
      preferences: z.object({
        certifiedSuppliers: z.coerce.boolean().optional(),
        verifiedBuyers: z.coerce.boolean().optional(),
...
export const ContractGenerationRequestSchema = z.object({
  data: z.object({
    ...
    attributes: z.object({
      templateId: CuidQueryParam('id'),
      orderId: CuidQueryParam('id'),
